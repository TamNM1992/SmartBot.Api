...
namespace SmartBot.Common.Configuration
{
	public class AppConfigs
	{
		...
		public static void LoadAll(IConfiguration configuration)
		{
            ...
            FileSearchCtv = GetConfigValue("Template:FileSearchCtv", "No value");
            ...
            SmartBotPath = GetConfigValue("Template:SmartBotPath", "");
        ...
        public static string SmartBotPath { get; set; }
        ...
        public static string FileSearchCtv { get; set; }
